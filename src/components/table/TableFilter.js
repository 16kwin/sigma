      ...
      <div className="filter-container">
        ...
        <table className="stats-table">
          <tr>
            ...
            <th className="stats-value">
              {header.mechanicCount || 0}<br/>
              {header.eletronCount || 0}<br/>
              {header.techCount || 0}<br/>
              {header.elecCount || 0}<br/>
              {header.conplectCount || 0}
            </th> 
            ...
            <th className="stats-value">
              {header.mechanicBusy || 0}<br/>
              {header.eletronBusy || 0}<br/>
              {header.techBusy || 0}<br/>
              {header.elecBusy || 0}<br/>
              {header.conplectBusy || 0}
            </th>  
            ...
            <th className="stats-value">
              {header.mechanicFree || 0}<br/>
              {header.eletronFree || 0}<br/>
              {header.techFree || 0}<br/>
              {header.elecFree || 0}<br/>
              {header.conplectFree || 0}
            </th> 
          </tr>
        </table>
